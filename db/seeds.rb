...
Card.create!(side_a: "Gary Busey", side_b: "On 3/4/13 at the Stanyan Ave. location, \"Lethal Weapon\" star Gary Busey ordered a sugar-free grande vanilla latte", deck_id: 8)
...
Card.create!(side_a: "For which luxury goods manufacturer was M. Gaultier creative director from 2003-2010?", side_b: "Hermès", deck_id: 9)
...
Card.create!(side_a: "Published in 2015", side_b: "Go Set a Watchman", deck_id: 10)
...
Card.create!(side_a: "Costa Rica", side_b: "colón", deck_id: 11)
...
Card.create!(side_a: "What is the top score achievable on this test?", side_b: "A 5", deck_id: 12)
...
Card.create!(side_a: "Which of these was an Impressionist painter: Picasso, Renoir, Kandinsky, Rousseau?", side_b: "Renoir", deck_id: 13)
...
Card.create!(side_a: "Which is better in the field, water or lighter fluid?", side_b: "The answer is water", deck_id: 14)
...
Card.create!(side_a: "Ffrog", side_b: "Dress", deck_id: 16)
...
Card.create!(side_a: "Paul [avait/était] sorti au ciné", side_b: "était", deck_id: 17)
...
Card.create!(side_a: "What does GSCE stand for?", side_b: "General Certificate of Secondary Education", deck_id: 18)
...
Card.create!(side_a: "What are the three regions of the small intestine?", side_b: "The duodenum, the jejunum, and the ileum", deck_id: 19)
...
Card.create!(side_a: "Adenine (A)", side_b: "Thymine (T)", deck_id: 20)
...
Card.create!(side_a: "All others are inferior to it", side_b: "Superior", deck_id: 21)
Tagging.create!(deck_id: 21, tag_id: 94)

Deck.create!(author_id: 4, title: "Geology Rocks!", description: "A very gneiss deck indeed")
Card.create!(side_a: "What are the three types of rock?", side_b: "Igneous, metamorphic, and alt/electronica", deck_id: 22)
...
Card.create!(side_a: "How do you calculate a triangle angle's cosine?", side_b: "adjacent side/hypotenuse", deck_id: 23)
...
Card.create!(side_a: "How long did the oldest verified person live?", side_b: "122 years, 164 days (Jeanne Calment)", deck_id: 24)
...
Card.create!(side_a: "The inventor of the Watt steam engine", side_b: "James Watt", deck_id: 32)
Tagging.create!(deck_id: 32, tag_id: 107)

Deck.create!(author_id: 5, title: "Plant Hormones", description: "a.k.a. phytohormones")
Card.create!(side_a: "What does ethylene do?", side_b: "It ripens", deck_id: 33)
...
Card.create!(side_a: "What must you never, ever do?", side_b: "Insult your basil to its face; only do so in a different room or outside of hearing distance", deck_id: 34)
Tagging.create!(deck_id: 34, tag_id: 109)

Deck.create!(author_id: 5, title: "SARS", description: "Stay informed")
Card.create!(side_a: "What does SARS stand for?", side_b: "Severe Acute Respiratory Syndrome", deck_id: 35)
