...
terry = User.create!(username: "Terry", password: "primrose")
mabel = User.create!(username: "Mabel", password: "iolanthe")
magnus = User.create!(username: "Magnus", password: "labyrinth")
oscar = User.create!(username: "Oscar", password: "fourscore")
wanda = User.create!(username: "Wanda", password: "watershed")

sylvester = User.create!(username: "Sylvester", password: "geranium")
yolanda = User.create!(username: "Yolanda", password: "cobalt")
delphine = User.create!(username: "Delphine", password: "parsimony")
truman = User.create!(username: "Truman", password: "drawbridge")
umberto = User.create!(username: "Umberto", password: "bureau")
egbert = User.create!(username: "Egbert", password: "jocund")
frida = User.create!(username: "Frida", password: "freelove")
cassius = User.create!(username: "Cassius", password: "sassafras")
zelda = User.create!(username: "Zelda", password: "vacuum")
aurora = User.create!(username: "Aurora", password: "kilimanjaro")
...
Subscription.create!(user_id: 6, deck_id: 36)
Subscription.create!(user_id: 8, deck_id: 36)
Subscription.create!(user_id: 10, deck_id: 36)
Subscription.create!(user_id: 12, deck_id: 36)
Subscription.create!(user_id: 14, deck_id: 36)


Deck.create!(author_id: 3, title: "Vocab: B", description: "B is for Bellicose")
Tagging.create!(deck_id: 37, tag_id: 233)
Card.create!(side_a: "Bailiwick", side_b: "one’s sphere of operations or particular area of interest", deck_id: 37, user_id: 3)
Card.create!(side_a: "Ballyhoo", side_b: "extravagant publicity or fuss; to praise or publicize extravagantly", deck_id: 37, user_id: 3)
Card.create!(side_a: "Banty", side_b: "a small person who behaves in a belligerent manner", deck_id: 37, user_id: 3)
Card.create!(side_a: "Barrows", side_b: "a heap of earth placed over one or more prehistoric tombs, often surrounded by ditches", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bathos", side_b: "an effect of anticlimax created by an unintentional lapse in mood from the sublime to the trivial or ridiculous", deck_id: 37, user_id: 3)
Card.create!(side_a: "Benighted", side_b: "in a state of pitiful or contemptible intellectual or moral ignorance, typically owing to a lack of opportunity", deck_id: 37, user_id: 3)
Card.create!(side_a: "Berm", side_b: "a flat strip of land, raised bank, or terrace bordering a river or canal; a path or grass strip beside a road", deck_id: 37, user_id: 3)
Card.create!(side_a: "Betimes", side_b: "before the usual or expected time; early", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bezel", side_b: "a grooved ring holding the glass or plastic cover of a watch face or other instrument in position", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bilious", side_b: "affected by or associated with nausea or vomiting; spiteful, bad-tempered", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bilirubin", side_b: "an orange-yellow pigment formed in the liver by the breakdown of hemoglobin and excreted in bile", deck_id: 37, user_id: 3)
Card.create!(side_a: "Billet", side_b: "a place, usually a civilian’s house or other nonmilitary facility, where soldiers are lodged temporarily; to lodge soldiers in such a place", deck_id: 37, user_id: 3)
Card.create!(side_a: "Blackguard", side_b: "a low, contemptible scoundrel; to revile in scurrilous language", deck_id: 37, user_id: 3)
Card.create!(side_a: "Blancmange", side_b: "a sweet dessert made with milk or cream and sugar thickened with gelatin, cornstarch or Irish moss, flavored with almonds", deck_id: 37, user_id: 3)
Card.create!(side_a: "Blandishment", side_b: "a flattering or pleasing statement or action used to persuade someone gently to do something", deck_id: 37, user_id: 3)
Card.create!(side_a: "Blat", side_b: "to make a loud or raucous noise", deck_id: 37, user_id: 3)
Card.create!(side_a: "Blotto", side_b: "extremely drunk", deck_id: 37, user_id: 3)
Card.create!(side_a: "Blowdown", side_b: "a tree or trees that have been blown down by the wind", deck_id: 37, user_id: 3)
Card.create!(side_a: "Blowsy", side_b: "coarse, untidy, and red-faced", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bluenose", side_b: "a priggish or puritanical person", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bobby sox", side_b: "short socks reaching just above the ankle", deck_id: 37, user_id: 3)
Card.create!(side_a: "Boffin", side_b: "British slang for a scientist, engineer, or other person engaged in technical or scientific work", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bole", side_b: "the trunk of a tree", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bolection", side_b: "a molding that projects beyond the face of a panel or frame, usually found in paneling, doors and fireplaces", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bond paper", side_b: "high-quality writing paper", deck_id: 37, user_id: 3)
Card.create!(side_a: "Boniface", side_b: "the proprietor of a hotel, nightclub or restaurant", deck_id: 37, user_id: 3)
Card.create!(side_a: "Boondoggle", side_b: "work or activity that is wasteful or pointless but gives the appearance of having value", deck_id: 37, user_id: 3)
Card.create!(side_a: "Boreal", side_b: "of the North or northern regions; relating to or characteristic of the climatic zone south of the Arctic", deck_id: 37, user_id: 3)
Card.create!(side_a: "Boscage", side_b: "massed trees or shrubs", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bradykinesia", side_b: "slowness of movement", deck_id: 37, user_id: 3)
Card.create!(side_a: "Breviary", side_b: "a book containing the service for each day, to be recited by those in orders in the Roman Catholic Church", deck_id: 37, user_id: 3)
Card.create!(side_a: "Broadside", side_b: "any strong or comprehensive attack, as by criticism", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bromide", side_b: "a trite and unoriginal idea or remark, typically intended to sooth or placate", deck_id: 37, user_id: 3)
Card.create!(side_a: "Buckram", side_b: "a stiff clock used to cover and protect books", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bugaboo", side_b: "something that causes fear or worry", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bull session", side_b: "an informal, typically impromptu discussion, especially among a small group", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bunko", side_b: "a swindle or confidence trick; to swindle or cheat", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bunkum", side_b: "nonsense", deck_id: 37, user_id: 3)
Card.create!(side_a: "Bushwa", side_b: "rubbish; nonsense", deck_id: 37, user_id: 3)
Card.create!(side_a: "Byre", side_b: "a cowshed", deck_id: 37, user_id: 3)
Subscription.create!(user_id: 1, deck_id: 37)
Subscription.create!(user_id: 2, deck_id: 37)
Subscription.create!(user_id: 4, deck_id: 37)
Subscription.create!(user_id: 5, deck_id: 37)
Subscription.create!(user_id: 6, deck_id: 37)
Subscription.create!(user_id: 7, deck_id: 37)
Subscription.create!(user_id: 8, deck_id: 37)
Subscription.create!(user_id: 9, deck_id: 37)
Subscription.create!(user_id: 10, deck_id: 37)
Subscription.create!(user_id: 11, deck_id: 37)
Subscription.create!(user_id: 12, deck_id: 37)
Subscription.create!(user_id: 13, deck_id: 37)
Subscription.create!(user_id: 14, deck_id: 37)
Subscription.create!(user_id: 15, deck_id: 37)
